				...
				<h:form prependId="false">
					<h:messages globalOnly="true" styleClass="error" />
						<div class="form-grid">
							...
							<div class="form-group">
								<label for="duration"><span
									style="color: red">*</span>Duration (days) </label>
						...
						<div class="button-group">
							<h:commandButton value="save Medicine"
								action="#{procedureController.updateCurrentMedicine(procedureController.prescribedMedicine)}"
								styleClass="btn-add" />
							<h:commandButton value="Reset Form"
								action="#{procedureController.resetCurrentMedicine()}"
								immediate="true" styleClass="btn-reset" />
							<h:commandButton value="back"
								action="#{procedureController.backFromCurrentMedicine()}"
