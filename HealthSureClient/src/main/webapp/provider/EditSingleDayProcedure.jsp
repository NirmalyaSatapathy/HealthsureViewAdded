...
<html>
<head>
    <title>Edit Medical Procedure</title>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/EditSingleDayProcedure.css" />
    <!-- Disable caching -->
    ...
    <div class="page-wrapper">
        ...
        <div class="main-content">
            <div class="form-container">
                <div class="form-title">Edit Single Day Medical Procedure</div>
                ...
                <h:form prependId="false">
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <h:inputText id="procedureDate" value="#{procedureController.procedure.procedureDate}"  styleClass="form-control" readonly="true">
                    ...
                    <div class="button-group">
                        <h:commandButton value="save Procedure"
                                         styleClass="btn-add"
                                         action="#{procedureController.updateSingleDayProcedure(procedureController.procedure)}" />

                        <h:commandButton value="Reset Form"
                                         styleClass="btn-reset"
                                         action="#{procedureController.resetSingleDay()}" />
